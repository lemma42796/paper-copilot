...
当前状态同步自 `TASKS.md`，更新时间为 2026-05-21。
...
| evidence `recall@5` | 82.1% | 13 条带 anchor queries 的均值；exact + semantic window match |
| evidence `recall@10` | 84.6% | paper 级命中后，证据 chunk 覆盖仍需继续改进 |
| evidence anchor `precision@5` | 43.6% | 只衡量 anchor/semantic-window 命中，不代表完整相关性 |
