...
MODEL_CONTEXT_WINDOW_TOKENS: Final[int] = 272_000
_EFFECTIVE_CONTEXT_WINDOW_PERCENT: Final[int] = 95
_AUTO_COMPACT_CONTEXT_WINDOW_PERCENT: Final[int] = 90
WORKING_CONTEXT_LIMIT_TOKENS: Final[int] = (
    MODEL_CONTEXT_WINDOW_TOKENS * _EFFECTIVE_CONTEXT_WINDOW_PERCENT // 100
)
AUTO_COMPACT_TRIGGER_TOKENS: Final[int] = (
    MODEL_CONTEXT_WINDOW_TOKENS * _AUTO_COMPACT_CONTEXT_WINDOW_PERCENT // 100
)
